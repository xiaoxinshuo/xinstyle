...
J.Element = (function($){
    ...
    var _init_checkbox = function(el){
        ...
        $el.on('tap',function(){
            ...
            */
            var status = ($el.attr('data-checkbox') == 'checked') ? 'unchecked':'checked';
            $el.attr('data-checkbox',status).find('i.icon').attr('class','icon checkbox-'+status);
            //自定义change事件
            $el.trigger('change');
        });
...
(function($){
    ...
    J.alert = function(content,okCall){
        J.Popup.alert(content,okCall);
    }
...
J.Popup = (function($){
    ...
    var _subscribeEvents = function(){
        ...
        /*_popup.one('tap','[data-target="closePopup"]',function(e){
        	hide();
        	e.stopPropagation();
        });*/
    }
     ...
     * @param content 内容
     */
    var alert = function(content,okCall){
        var markup = TEMPLATE.alert.replace('{title}','提示').replace('{content}',content).replace('{ok}','确定');
        show({
            html : markup,
            pos : 'center',
        ...
        $('#popup_btn_container').click(function(e){
        	e.stopPropagation();
            hide();
        	if(okCall && okCall!=null){
            	okCall.call(this);
            }
        });
    }
    ...
    var confirm = function(title,content,okCall,cancelCall){
        ...
        $('#popup_btn_container [data-icon="checkmark"]').click(function(e){
        	e.stopPropagation();
            hide();
            okCall.call(this);
        });
        $('#popup_btn_container [data-icon="close"]').click(function(e){
        	e.stopPropagation();
            hide();
            if(cancelCall && cancelCall!=null){
